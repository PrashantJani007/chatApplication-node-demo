...
app.get('/user/logout',auth,(req,res)=>{
    console.log("kshj fsgfyujsdtf78384783fdysgfdjsgfyusdf67sdt67sdfvsfvs ");
    let index = user_ids.findIndex(data => data.user_id === req.user_id);
    if (index !== -1) {
        user_ids.splice(index, 1);
    }
    console.log(user_ids,"Logout");
...
io.on('connection', (socket) => {
    ...
    //     }
    //     console.log(user_ids,"Logout");
    //     // io.sockets.emit('userLogout', user_id);
    // });
